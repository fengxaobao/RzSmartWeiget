package com.rz.keeplive.service
...
import com.rz.keeplive.config.NotificationUtils
import com.rz.keeplive.receiver.NotificationClickReceiver
...
class JobHandlerService : JobService() {
    ...
    override fun onStartJob(jobParameters: JobParameters): Boolean {
        if (!isServiceRunning(
                applicationContext,
                "com.xiyang51.keeplive.service.LocalService"
            ) || !isServiceRunning(applicationContext, "$packageName:remote")
        ) {
            startService(this)
        }
        return false
