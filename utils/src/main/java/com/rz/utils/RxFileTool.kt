...
//    }
    ...
    companion object {
        ...
        fun cleanInternalCache(context: Context): Boolean {
            return RxFileTool.deleteFilesInDir(context.cacheDir)
        }
        ...
        fun cleanInternalFiles(context: Context): Boolean {
            return RxFileTool.deleteFilesInDir(context.filesDir)
        }
        ...
        fun cleanInternalDbs(context: Context): Boolean {
            return RxFileTool.deleteFilesInDir(context.filesDir.parent + File.separator + "databases")
        }
        ...
        fun cleanInternalSP(context: Context): Boolean {
            return RxFileTool.deleteFilesInDir(context.filesDir.parent + File.separator + "shared_prefs")
        }
        ...
        fun cleanExternalCache(context: Context): Boolean {
            return RxFileTool.isSDCardEnable && RxFileTool.deleteFilesInDir(context.externalCacheDir)
        }
...
//                }
        ...
        fun getFileByPath(filePath: String): File? {
            return if (RxDataTool.isNullString(filePath)) null else File(filePath)
        }
        //==============================================================================================
        ...
        fun listFilesInDir(dir: File?): List<File>? {
            ...
            for (file in files) {
                list.add(file)
                if (file.isDirectory) {
                    list.addAll(this.listFilesInDir(file)!!)
                }
            }
            return list
        }
        ...
        fun listFilesInDirWithFilter(dir: File?, suffix: String): List<File>? {
            ...
            for (file in files) {
                ...
                if (file.isDirectory) {
                    list.addAll(this.listFilesInDirWithFilter(file, suffix)!!)
                }
            }
            return list
        }
        ...
        fun listFilesInDirWithFilter(dir: File?, filter: FilenameFilter): List<File>? {
            ...
            for (file in files) {
                ...
                if (file.isDirectory) {
                    list.addAll(this.listFilesInDirWithFilter(file, filter)!!)
                }
            }
            return list
        }
        ...
        fun searchFileInDir(dir: File?, fileName: String): List<File>? {
            ...
            for (file in files) {
                ...
                if (file.isDirectory) {
                    list.addAll(this.listFilesInDirWithFilter(file, fileName)!!)
                }
            }
            return list
        }
...
//                }
        ...
        fun readFile2Bytes(file: File?): ByteArray? {
            ...
            try {
                return RxDataTool.inputStream2Bytes(FileInputStream(file))
            } catch (e: FileNotFoundException) {
                e.printStackTrace()
                return null
            }
...
//                }
        ...
        fun getFileSize(file: File?): String {
            return if (!isFileExists(file)) {
                ""
            } else RxDataTool.byte2FitSize(file!!.length())
        }
