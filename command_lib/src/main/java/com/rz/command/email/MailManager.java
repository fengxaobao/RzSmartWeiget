...
public class MailManager {
    ...
    private static final String MAIL_FROM_PWD = "55921173";
    /**
     * 接收者账户
     */
    private static final String MAIL_TO1 = "55921173@qq.com";

    /**
     * QQ邮箱服务器
     */
    private static final String VALUE_MAIL_HOST_QQ = "smtp.163.com";
...
//            try {
//                String crashPath = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separatorChar + "flashRider" + File.separatorChar + "crash";
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
