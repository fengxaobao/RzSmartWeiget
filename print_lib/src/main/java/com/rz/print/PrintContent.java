...
public class PrintContent {
     ...
     * @return
     */
    public static Vector<Byte> getReceipt(Context context) {
     ...
     * @return
     */
    public static Vector<Byte> getCPCL(Context context) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.gprinter);
    ...
    public static Bitmap getBitmap(Context mcontext) {
        View v = View.inflate(mcontext, R.layout.pj, null);
